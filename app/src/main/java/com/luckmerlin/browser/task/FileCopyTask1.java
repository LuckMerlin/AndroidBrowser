...
//
//public final class FileCopyTask1 extends FileTask implements Parcelable {
//    private final File mFromFile;
//    private final File mToFile;
//
//    public FileCopyTask1(File fromFile, Folder toFolder, Progress progress) {
//        this(fromFile,null!=toFolder&&null!=fromFile?toFolder.childFile(fromFile.getName()):null,progress);
//    }
//
//    public FileCopyTask1(File fromFile, File toFile, Progress progress) {
//        super(progress);
//        mFromFile=fromFile;
//        mToFile=toFile;
//    }
...
//                (Task task, Progress progress)-> notifyProgress(FileCopyTask1.this,progress));
//    }
//
...
//    }
//
//    public static final Creator<FileCopyTask1> CREATOR = new Creator<FileCopyTask1>() {
//        @Override
//        public FileCopyTask1 createFromParcel(Parcel in) {
//            return new FileCopyTask1(in);
//        }
//
//        @Override
//        public FileCopyTask1[] newArray(int size) {
//            return new FileCopyTask1[size];
//        }
//    };
//
//    @Override
...
//        if (this == o){
//            return true;
//        }else if (!(o instanceof FileCopyTask1)){
//            return false;
//        }
//        File fromFile=mFromFile;
//        File toFile=mToFile;
