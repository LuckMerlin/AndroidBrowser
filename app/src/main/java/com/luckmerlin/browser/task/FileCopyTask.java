...
//
//    public FileCopyTask(File fromFile, Folder toFolder) {
//        this(fromFile,null!=toFolder&&null!=fromFile?toFolder.childFile(fromFile.getName()):null);
//    }
//
//    public FileCopyTask(File fromFile, File toFile) {
//        mFromFile=fromFile;
//        mToFile=toFile;
//    }
//
