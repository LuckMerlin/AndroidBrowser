...
@Deprecated
public class DoingTaskContent1 extends ConfirmContent implements
    ...
    protected View onCreateContent(Context context) {
        DoingContentBinding binding=inflate(context,R.layout.doing_content);
...
//        }
    ...
    public final DoingTaskContent1 setDoingBinding(Binding binding){
        if (!isUiThread()){
    ...
    public final DoingTaskContent1 setAutoDismiss(AutoDismiss autoDismiss) {
