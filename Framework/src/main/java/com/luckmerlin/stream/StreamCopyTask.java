...
//
//    public StreamCopyTask(InputStream inputStream, OutputStream outputStream) {
//        this(inputStream,outputStream,null,progress);
//    }
//
//    public StreamCopyTask(InputStream inputStream, OutputStream outputStream,byte[] buffer) {
//        super(progress);
//        mBuffer=buffer;
